...
import { VScrollArea } from "@/shared/components";

import { VTableHeader } from "./components/VTableHeader";
import { VTableHead } from "./components/VTableHead";
import { VTableBody } from "./components/VTableBody";
