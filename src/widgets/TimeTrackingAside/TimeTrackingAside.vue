...
import { TimeTrackingFilter } from "@/widgets/TimeTrackingFilter";

import { TimeTrackingItem } from "@/features/TimeTrackingItem";

import { VForm, VDatePicker } from "@/shared/components";
...
export default {
  ...
  computed: {
    dateRanges() {
      const rangeTypes = {
        week: {
          label: this.contextTranslate("Week"),
          icon: ViewDay,
        },
        month: {
          label: this.contextTranslate("Month"),
          icon: ViewGrid,
        },
        quarter: {
          label: this.contextTranslate("Quarter"),
          icon: ViewModule,
        },
        year: {
          label: this.contextTranslate("Year"),
          icon: ViewComfy,
        },
      };
    ...
    activeDateLabel() {
      switch (this.rangeType) {
        ...
        case "month": {
          ...
          const textMonth = this.contextTranslate(MONTHS[month]);
          const year = getYear(this.activeDate);
