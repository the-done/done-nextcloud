    ...
    <VPageLayout>
      <VPageContent>
        ...
        <template v-else>
          ...
          <div class="mt-8 border-t border-(--color-border)">
            <div class="max-w-[600px] p-4 flex justify-end">
              <NcButton
                type="primary"
                :disabled="isSaving"
                @click="saveSettings"
...
import { VPage, VPageLayout, VPageContent } from "@/widgets";

import { VLoader, VToolbar, VDropdown } from "@/shared/components";
