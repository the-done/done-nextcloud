    ...
    <VPagePadding v-if="isInitLoading === false">
      <div v-if="hasWarnings === true" class="flex flex-col gap-1 mb-4">
        ...
        >
          ...
          <RouterLink
            :to="{ name: 'settings-staff-positions-new' }"
        ...
        >
          ...
          <RouterLink
            :to="{ name: 'settings-staff-contract-types-new' }"
            class="v-link v-link--underline"
          >
...
import { createUser, updateUser, fetchUserBySlug } from "@/entities/users/api";
import { fetchFreeNextcloudUsers } from "@/entities/nextcloud/api";
import { saveDynamicFieldsDataMultiple } from "@/entities/dynamicFields/api";
import {
