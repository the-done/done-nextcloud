...
class FieldCommentModel extends BaseModel
{
    ...
    public array $fields = [
        ...
        'source' => [
            ...
            'title'      => 'Source entity',
            'required'   => true,
            'db_comment' => 'Entity source identifier. See OCA\Done\Models\PermissionsEntitiesModel constants (e.g., 1 - Users, 2 - Projects).',
            'show'       => true,
        ],
        'field' => [
            'type'             => IQueryBuilder::PARAM_STR,
