...
/**
 * Class GlobalRolesModel.
 */
class GlobalRolesModel extends BaseModel
{
    ...
    public const CAN_VIEW_USERS_LIST_RELATED = 'canViewEmployeesListRelated';
    public const CAN_READ_PROJECTS_LIST = 'canReadProjectsList';
    public const CAN_VIEW_PROJECTS_LIST_RELATED = 'canViewProjectsListRelated';
    ...
    public function getRolesActions(): array
    {
        return [
            ...
            self::CAN_VIEW_USERS_LIST_RELATED => 'View employees list related to me',
            ...
            self::CAN_VIEW_PROJECTS_LIST_RELATED => 'View projects list related to me',
    ...
    public static function getUsersDefaultRights(): array
    {
        return [
            ...
            self::CAN_VIEW_USERS_LIST_RELATED    => false,
            ...
            self::CAN_VIEW_PROJECTS_LIST_RELATED => false,
