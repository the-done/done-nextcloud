...
/**
 * Class DynamicFieldsDataAbstractModel.
 */
abstract class DynamicFieldsDataAbstractModel extends BaseModel
{
    /**
    ...
    public function getDynFieldValueByType(
        ...
        switch ($dynFieldType) {
            case DynamicFieldsTypesModel::INTEGER:
                $value = $item['int_val'];
                break;

            case DynamicFieldsTypesModel::FLOAT:
                $value = $item['float_val'];
                break;

            case DynamicFieldsTypesModel::STRING:
                $value = $item['string_val'];
                break;

            case DynamicFieldsTypesModel::TEXT:
                $value = $item['text_val'];
                break;

            case DynamicFieldsTypesModel::DATE:
                $value = $item['date_val'];
                break;

            case DynamicFieldsTypesModel::DATETIME:
                $value = $item['datetime_val'];
                break;

            case DynamicFieldsTypesModel::DROPDOWN:
                $values = [];
    ...
    public static function getColumnByType(?int $dynFieldType): ?string
    {
        return match ($dynFieldType) {
            DynamicFieldsTypesModel::INTEGER  => 'int_val',
            DynamicFieldsTypesModel::FLOAT    => 'float_val',
            DynamicFieldsTypesModel::STRING   => 'string_val',
            DynamicFieldsTypesModel::TEXT     => 'text_val',
            DynamicFieldsTypesModel::DATE     => 'date_val',
            DynamicFieldsTypesModel::DATETIME => 'datetime_val',
            DynamicFieldsTypesModel::DROPDOWN => null,
            default                           => '',
        };
    }
}
