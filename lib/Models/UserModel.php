...
use OCA\Done\Models\Appearance\UserAppearanceModel;
...
class UserModel extends BaseModel
{
    ...
    public array $linkedModels = [
        UsersToDirectionsModel::class => [
            'title'         => 'Directions',
            'frontend_type' => 'directions',
            'filter_field'  => 'user_id',
            'key_field'     => 'direction_id',
        ],
        UsersGlobalRolesModel::class => [
            'title'         => 'Roles',
            'frontend_type' => 'roles',
            'filter_field'  => 'user_id',
            'key_field'     => 'role_id',
    ...
    public string $appearanceModel = UserAppearanceModel::class;
    ...
    public function getListForLink(
        ...
        $positionsList = !empty($positionsIds)
            ? (new PositionsModel())->getIndexedListByFilter(
                'id',
                ['id' => ['IN', $positionsIds, IQueryBuilder::PARAM_STR_ARRAY]]
            ) : [];
    ...
    public function addFirstUser(string $currentUserUid): string
    {
        ...
        (new UsersGlobalRolesModel())->addData(['user_id' => $userId, 'role_id' => GlobalRolesModel::ADMIN]);
