...
class ProjectModel extends BaseModel
{
    ...
    public array $linkedModels = [
        UsersRolesInProjectsModel::class => [
            'title'         => 'Employees',
            'frontend_type' => 'staff',
    ...
    public string $appearanceModel = ProjectAppearanceModel::class;
